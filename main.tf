...
resource "aws_rds_cluster_instance" "this" {
  ...
  performance_insights_replica    = "${var.performance_insights_replica}"
  performance_insights_enabled    = "${count.index > 0 ? coalesce(var.instance_type_replica, var.performance_insights_enabled) : var.performance_insights_enabled}"
